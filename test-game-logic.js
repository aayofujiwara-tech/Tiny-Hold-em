...
runTest('バディA comm=⚔️A: 赤A vs 青A → チョップ（スート廃止）', () => {
...
runTest('チョップ: comm=💎Q, hand1=💀10, hand2=⚔️10 → 同役同数字でチョップ', () => {
...
runTest('チョップ: comm=💎A, hand1=💀A, hand2=⚔️A → バディ同数字でチョップ', () => {
...
runTest('チョップ: comm=⚔️K, hand1=💀Q, hand2=💎Q → スト同数字でチョップ', () => {
